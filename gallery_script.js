    ...
    function formatDate(dateStr, shortYear = false) {
        ...
        if (shortYear) {
            return `<div class="date-dm" style="display:block; white-space:nowrap; font-weight:700; font-size:12px; line-height:1.2;">${day} ${month}</div><div class="date-y" style="display:block; white-space:nowrap; font-size:11px; color:#555555; line-height:1.1; margin-top:2px;">${fullYear}</div>`;
        } else {
