...
<div class="no-print" style="position:fixed; bottom:25px; right:25px; z-index:99999;">
    <button onclick="window.print()" style="background:linear-gradient(135deg,#ff8c00,#d97706); color:#ffffff; border:none; padding:12px 22px; border-radius:30px; font-weight:700; font-size:14px; font-family:'Poppins','Noto Sans Devanagari',sans-serif; box-shadow:0 4px 20px rgba(0,0,0,0.4); cursor:pointer; display:flex; align-items:center; gap:8px; transition:all 0.2s ease;">
        <span style="font-size:16px;">🖨️</span> PDF सेव्ह करा (Vector HD)
    </button>
</div>
</body></html>`;
    }
