    ...
    async function generatePDFHTML(entries, year, logoDataURL) {
        ...
        try {
            ...
            if (pdfHeaderImg.startsWith('logo/pdf_header_banner_opt.jpg') && typeof document !== 'undefined') {
                ...
                let committeeHtml = '<div style="display:flex; justify-content:space-between; margin-top:30px; padding:0 30px;"><div style="text-align:center;"><div style="font-weight:800; font-size:20px; color:#5a2010; margin-bottom:5px;">अध्यक्ष</div><div style="font-weight:700; font-size:26px; color:#1a1a2e;">तेजस फटांगरे</div><div style="font-size:13px; color:#555555; margin-top:3px;">मो. नं - 9370599259</div></div><div style="text-align:center;"><div style="font-weight:800; font-size:20px; color:#5a2010; margin-bottom:5px;">खजिनदार</div><div style="font-weight:700; font-size:26px; color:#1a1a2e;">धनंजय रणाते</div><div style="font-size:13px; color:#555555; margin-top:3px;">मो. नं - 9322134560</div></div></div>';
        try {
