...
\\n
 + \
\\n
</style></head><body><div class="cover-page"><div class="cover-outer-border"></div><div class="cover-inner-border"></div><div class="cover-corner tl"></div><div class="cover-corner tr"></div><div class="cover-corner bl"></div><div class="cover-corner br"></div><div class="cover-content"><div class="cover-logo-wrap"><div class="cover-logo-glow"></div><div class="cover-logo-ring"></div><div class="cover-logo-ring2"></div><img src="' + logoSrc + '" alt="Logo" class="cover-logo" onerror="this.style.display=\'none\'"></div><div class="cover-mandal-name">' + s.orgName + '</div><div class="cover-divider"></div><div style="display:flex;align-items:baseline;justify-content:center;flex-wrap:wrap;gap:15px;margin-bottom:10px;text-align:center;"><span class="cover-subtitle" style="display:inline;">' + s.subtitle + '</span><span class="cover-tagline" style="display:inline;">' + (s.tagline === 'Ganpati Festival Cashbook' ? 'वर्ष : आठवे' : s.tagline) + '</span></div><div class="cover-year-box"><span class="cover-year-label">सन</span><span class="cover-year-val">' + year + '</span></div></div><div class="cover-footer"><div class="cover-footer-om">ॐ गण गणपतये नमः</div><p>Developed by | Dhananjay Ranate</p></div></div><div class="inner-page"><div style="width:100%;border-bottom:3px solid #ff8c00;padding:8px;box-sizing:border-box;"><img src="logo/pdf_header_banner.png" style="width:100%;height:170px;object-fit:fill;display:block;border:2px solid #ffd700;border-radius:8px;box-shadow:0 4px 15px rgba(255, 215, 0, 0.45);" alt="Header" onerror="this.onerror=null; this.src=\'logo/logo1.jpeg\';"></div><div class="page-body"><div class="summary-section"><div class="summary-title">Financial Summary</div><div class="summary-row"><div class="sum-card green"><h4>Total Cash In (+)</h4><div class="val">' + formatPDFCurrency(totalCashIn) + '</div></div><div class="sum-card red"><h4>Total Cash Out (-)</h4><div class="val">' + formatPDFCurrency(totalCashOut) + '</div></div><div class="sum-card purple"><h4>Final Balance</h4><div class="val">' + formatPDFCurrency(finalBalance) + '</div></div></div></div><div class="table-section"><div class="table-heading">Transaction Records</div><table class="data-table"><thead><tr><th class="sr-no">#</th><th class="remark">Name</th><th class="date">Date</th><th class="mode">Mode</th><th class="right-align">Cash In (+)</th><th class="right-align">Cash Out (-)</th><th class="right-align">Balance</th></tr></thead><tbody>' + rows + '</tbody></table></div><div style=\"page-break-inside:avoid;break-inside:avoid;-webkit-column-break-inside:avoid;width:100%;\"><div style=\"height:1.5px;background:linear-gradient(90deg,#ff8c00,#ffd700,#ff8c00);margin:12px 0 8px 0;border-radius:2px;\"></div><div style=\"display:flex; justify-content:space-between; margin-top:30px; padding:0 30px;\"><div style=\"text-align:center;\"><div style=\"font-weight:800; font-size:15px; color:#5a2010; margin-bottom:5px;\">अध्यक्ष</div><div style=\"font-weight:700; font-size:16px; color:#1a1a2e;\">तेजस फटांगरे</div><div style=\"font-size:13px; color:#555555; margin-top:3px;\">मो. नं - 9370599259</div></div><div style=\"text-align:center;\"><div style=\"font-weight:800; font-size:15px; color:#5a2010; margin-bottom:5px;\">खजिनदार</div><div style=\"font-weight:700; font-size:16px; color:#1a1a2e;\">धनंजय रणाते</div><div style=\"font-size:13px; color:#555555; margin-top:3px;\">मो. नं - 9322134560</div></div></div><div class="page-footer" style=\"margin-top:40px; padding-bottom:20px;\"><div style=\"margin-bottom:8px; font-weight:600; font-size:13px; color:#1a1a2e; text-align:center;\">अधिकृत वेबसाईट : <a href=\"https://shivsrushti-utsav-mandal.onrender.com\" target=\"_blank\" style=\"color:#0000ee; text-decoration:none;\">https://shivsrushti-utsav-mandal.onrender.com</a></div><div class="dev" style=\"font-size:13px; color:#475569; font-weight:600; text-align:center;\">Developed by | Dhananjay Ranate</div></div></div></div></div></body></html>';
    }
