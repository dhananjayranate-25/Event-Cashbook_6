...
@media (max-width: 480px) {
    ...
    /* Force one line, reduce font and padding. NO ellipsis here, we want full text */
    ...
    .year-section th:nth-child(2), .year-section td:nth-child(2) { width: 23% !important; text-align: left !important; }
    /* Left align Date to reduce gap between Name and Date */
    .year-section th:nth-child(3), .year-section td:nth-child(3) { width: 14% !important; text-align: left !important; padding-left: 5px !important; }
    .year-section th:nth-child(4), .year-section td:nth-child(4) { width: 9% !important; text-align: center !important; }
    ...
    .year-section th:nth-child(7), .year-section td:nth-child(7) { width: 17% !important; text-align: right !important; }
